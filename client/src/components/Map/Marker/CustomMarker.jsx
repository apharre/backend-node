...
function CustomMarker({ key, camera, setHoverCamera, setCurrentCamera }) {
  /**
   ...
   * @param {!setHoverCamera} func sets the hoverCamera object for the hovering function and the info window
