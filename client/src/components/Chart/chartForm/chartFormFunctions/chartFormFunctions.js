...
function extractDate(date) {
   ...
   * @return {String} The stringified date in the format year-month-day (2022-12-25)
   */
...
function combineDateAndTimes(dateValue, firstDayTime, secondDayTime) {
   ...
   * @return {Arr[int]} An array containig two date objects that have been combined and now are in Unix time for the API query. The "/ 1000" is to convert to seconds from miliseconds
   */
